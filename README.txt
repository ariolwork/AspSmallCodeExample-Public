...
## Масштабирование
Если сделать все верно. Использовать очереди, приоритеты для задач(или возможно поделить сервисы) и распеределенный кэш(для фильтрации) для данной задачи масштабирование не будет какой то сложной задачей.
Остается только поднять какой-нибудь loadbalancer.
Из не важных доработок, еще перенес бы настройки handlers в Environment Variables. Тогда будет сильно удобнее настраивать кластер.
